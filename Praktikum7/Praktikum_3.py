...
class Ketupat(metaclass=KetupatMeta):
    pass
t = Ketupat()
# Menghitung luas permukaan ketupat dengan D1=7 dan D2=7
luas_ketupat = Ketupat.luas(7, 7)
print("Luas Ketupat:", luas_ketupat)

# Menghitung volume ketupat dengan D1=8 dan D2=5 dan tinggi=8
volume_ketupat = Ketupat.volume(8, 5, 8)
